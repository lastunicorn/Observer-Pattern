...
namespace ObserverPattern._06_CSharpEventsStandard
{
    internal class Client
    {
        ...
        public Client(string name, PrintingHouse printingHouse, Log log)
        {
            ...
            printingHouse.BookPrinted += HandleBookPrinted;
            log.WriteAsClient(name, "Subscribed to books.");

            printingHouse.NewspaperPrinted += HandleNewspaperPrinted;
            log.WriteAsClient(name, "Subscribed to newspapers.");
        }

        public void HandleBookPrinted(object sender, BookPrintedEventArgs e)
        {
            Book book = e.Book;
        ...
        public void HandleNewspaperPrinted(object sender, NewspaperPrintedEventArgs e)
        {
            Newspaper newspaper = e.Newspaper;
