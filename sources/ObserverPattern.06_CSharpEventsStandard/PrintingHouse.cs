...
namespace ObserverPattern._06_CSharpEventsStandard
{
    internal class PrintingHouse
    {
        ...
        public void PrintRandomBook()
        {
            ...
            BookPrintedEventArgs args = new(book);
            OnBookPrinted(args);
        }
        ...
        public void PrintNewspaper()
        {
            ...
            NewspaperPrintedEventArgs args = new(newNewspaper);
            OnNewspaperPrinted(args);
        }

        protected virtual void OnBookPrinted(BookPrintedEventArgs args)
        {
            BookPrinted?.Invoke(this, args);
        }

        protected virtual void OnNewspaperPrinted(NewspaperPrintedEventArgs args)
        {
            NewspaperPrinted?.Invoke(this, args);
        }
    }
}