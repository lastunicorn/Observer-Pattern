...
namespace ObserverPattern._02_ExtractEventClass
{
    internal class PrintingHouse
    {
        ...
        public BookPrintedEvent BookPrinted { get; } = new();

        public NewspaperPrintedEvent NewspaperPrinted { get; } = new();
        ...
        public void PrintNewspaper()
        {
            ...
            NewspaperPrinted.Notify(newNewspaper);
        }
    }
}